...
# build 3layer of cnn
base_model_input<-layer_input(shape=c(img_size,3))
...
model<-keras_model(inputs=base_model_input,outputs=predictions)
...
#save model for record
save_model_hdf5(model,"1_3_cnn_200_layer256")
